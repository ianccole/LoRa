...
#define lora_DIO2 6                   //pin number for radio tone generation, connects to LoRa device pin DIO2
#define lora_DIO0 2                   //pin connected to DIO0 on LoRa device
#define LED1 8                        //pin number for LED 
#define ADC_Channel 0                  //define a ADC channel that is open circuit in order to generate a pseudo random seed 
